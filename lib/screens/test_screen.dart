...
class VocationalTestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Test Vocacional UT San Juan', debugShowCheckedModeBanner: false,
      theme: ThemeData(
...
class _VocationalTestScreenState extends State<VocationalTestScreen> {
  ...
  Widget _buildResultScreen() {
    ...
    if (topCategory == 'A') {
      ...
      recommendation = 'Tu enfoque principal es la Gestión de Procesos, Eficiencia y Sistemas Lógicos. Tus carreras sugeridas son Ingeniería en Sistemas Productivos e Ingeniería en Desarrollo de Software, Inteligencia Artificial (TI).';
          ...
          child: Column(
            ...
            children: [
              const Text(
                ...
                style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 249, 249, 250)),
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 249, 249, 251)),
                textAlign: TextAlign.center,
              ),
...
@override
  Widget build(BuildContext context) {
    ...
    final String appBarTitle = _questionIndex < _questions.length
        ? 'Test Vocacional UT -Pregunta ${_questionIndex + 1} de ${_questions.length}'
        : 'Test Vocacional UT';
